...
const OpenAIIcon = forwardRef(({ size = 20, color = 'currentColor', strokeWidth = 2, className = '' }, ref) => {
  ...
  return (
    <motion.svg
      ...
      style={{ cursor: 'pointer', userSelect: 'none', display: 'inline-block', verticalAlign: 'middle' }}
    >
